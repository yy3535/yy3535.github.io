...
<html lang="en-US">
  ...
  GitHub
  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a></div> <!----></nav>  <ul class="sidebar-links"><li><div class="sidebar-group first"><p class="sidebar-heading open"><span>js</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/js/jsbasic/" class="sidebar-link">01-JS基础知识</a></li><li><a href="/Frontend/js/jsbasic/zepto.html" class="sidebar-link">zepto源码解读</a></li><li><a href="/Frontend/js/jsbasic/shenrubibao.html" class="sidebar-link">深入理解javascript原型链和闭包</a></li><li><a href="/Frontend/js/jswebapi/" class="sidebar-link">02-JS-WEB-API</a></li><li><a href="/Frontend/js/devenv/" class="sidebar-link">03-开发环境</a></li><li><a href="/Frontend/js/runenv/" class="sidebar-link">04-运行环境</a></li><li><a href="/Frontend/js/es6/" class="sidebar-link">ES6</a></li><li><a href="/Frontend/js/designpatterns/" class="sidebar-link">前端设计模式</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>css</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/css.html" class="sidebar-link">css</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>vue</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/vue.html" class="sidebar-link">vue</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>webpack</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/webpack.html" class="sidebar-link">webpack</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>前端跳槽面试必备技巧</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/viewskills.html" class="sidebar-link">前端跳槽面试必备技巧</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>小工具</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/vuepress.html" class="sidebar-link">vuepress</a></li><li><a href="/Frontend/markdown.html" class="sidebar-link">markdown</a></li></ul></div></li></ul> </div> <div class="page"> <div class="content"><h1 id="_2-0-1-2018-09-19"><a href="#_2-0-1-2018-09-19" aria-hidden="true" class="header-anchor">#</a> 2.0.1 / 2018-09-19</h1> <ul><li>deps: safe-buffer@5.1.2</li></ul> <h1 id="_2-0-0-2017-09-12"><a href="#_2-0-0-2017-09-12" aria-hidden="true" class="header-anchor">#</a> 2.0.0 / 2017-09-12</h1> <ul><li>Drop support for Node.js below 0.8</li> <li>Remove <code>auth(ctx)</code> signature -- pass in header or <code>auth(ctx.req)</code></li> <li>Use <code>safe-buffer</code> for improved Buffer API</li></ul> <h1 id="_1-1-0-2016-11-18"><a href="#_1-1-0-2016-11-18" aria-hidden="true" class="header-anchor">#</a> 1.1.0 / 2016-11-18</h1> <ul><li>Add <code>auth.parse</code> for low-level string parsing</li></ul> <h1 id="_1-0-4-2016-05-10"><a href="#_1-0-4-2016-05-10" aria-hidden="true" class="header-anchor">#</a> 1.0.4 / 2016-05-10</h1> <ul><li>Improve error message when <code>req</code> argument is not an object</li> <li>Improve error message when <code>req</code> missing <code>headers</code> property</li></ul> <h1 id="_1-0-3-2015-07-01"><a href="#_1-0-3-2015-07-01" aria-hidden="true" class="header-anchor">#</a> 1.0.3 / 2015-07-01</h1> <ul><li>Fix regression accepting a Koa context</li></ul> <h1 id="_1-0-2-2015-06-12"><a href="#_1-0-2-2015-06-12" aria-hidden="true" class="header-anchor">#</a> 1.0.2 / 2015-06-12</h1> <ul><li>Improve error message when <code>req</code> argument missing</li> <li>perf: enable strict mode</li> <li>perf: hoist regular expression</li> <li>perf: parse with regular expressions</li> <li>perf: remove argument reassignment</li></ul> <h1 id="_1-0-1-2015-05-04"><a href="#_1-0-1-2015-05-04" aria-hidden="true" class="header-anchor">#</a> 1.0.1 / 2015-05-04</h1> <ul><li>Update readme</li></ul> <h1 id="_1-0-0-2014-07-01"><a href="#_1-0-0-2014-07-01" aria-hidden="true" class="header-anchor">#</a> 1.0.0 / 2014-07-01</h1> <ul><li>Support empty password</li> <li>Support empty username</li></ul> <h1 id="_0-0-1-2013-11-30"><a href="#_0-0-1-2013-11-30" aria-hidden="true" class="header-anchor">#</a> 0.0.1 / 2013-11-30</h1> <ul><li>Initial release</li></ul></div> <div class="page-edit"><!----> <div class="last-updated"><span class="prefix">上次更新: </span> <span class="time">5/25/2019, 4:55:53 PM</span></div></div> <!----> </div> <!----></div></div>
    <script src="/assets/js/app.bbf0b81e.js" defer></script><script src="/assets/js/34.0f04744a.js" defer></script>
  </body>
</html>
