...
<html lang="en-US">
  ...
  GitHub
  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a></div> <!----></nav>  <ul class="sidebar-links"><li><div class="sidebar-group first"><p class="sidebar-heading open"><span>js</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/js/jsbasic/" class="sidebar-link">01-JS基础知识</a></li><li><a href="/Frontend/js/jsbasic/zepto.html" class="sidebar-link">zepto源码解读</a></li><li><a href="/Frontend/js/jsbasic/shenrubibao.html" class="sidebar-link">深入理解javascript原型链和闭包</a></li><li><a href="/Frontend/js/jswebapi/" class="sidebar-link">02-JS-WEB-API</a></li><li><a href="/Frontend/js/devenv/" class="sidebar-link">03-开发环境</a></li><li><a href="/Frontend/js/runenv/" class="sidebar-link">04-运行环境</a></li><li><a href="/Frontend/js/es6/" class="sidebar-link">ES6</a></li><li><a href="/Frontend/js/designpatterns/" class="sidebar-link">前端设计模式</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>css</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/css.html" class="sidebar-link">css</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>vue</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/vue.html" class="sidebar-link">vue</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>webpack</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/webpack.html" class="sidebar-link">webpack</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>前端跳槽面试必备技巧</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/viewskills.html" class="sidebar-link">前端跳槽面试必备技巧</a></li></ul></div></li><li><div class="sidebar-group"><p class="sidebar-heading"><span>小工具</span> <!----></p> <ul class="sidebar-group-items"><li><a href="/Frontend/vuepress.html" class="sidebar-link">vuepress</a></li><li><a href="/Frontend/markdown.html" class="sidebar-link">markdown</a></li></ul></div></li></ul> </div> <div class="page"> <div class="content"><h1 id="_2-3-0-2015-05-26"><a href="#_2-3-0-2015-05-26" aria-hidden="true" class="header-anchor">#</a> 2.3.0 / 2015-05-26</h1> <ul><li>Add defined behavior for HTTP <code>CONNECT</code> requests</li> <li>Add defined behavior for HTTP <code>Upgrade</code> requests</li> <li>deps: ee-first@1.1.1</li></ul> <h1 id="_2-2-1-2015-04-22"><a href="#_2-2-1-2015-04-22" aria-hidden="true" class="header-anchor">#</a> 2.2.1 / 2015-04-22</h1> <ul><li>Fix <code>isFinished(req)</code> when data buffered</li></ul> <h1 id="_2-2-0-2014-12-22"><a href="#_2-2-0-2014-12-22" aria-hidden="true" class="header-anchor">#</a> 2.2.0 / 2014-12-22</h1> <ul><li>Add message object to callback arguments</li></ul> <h1 id="_2-1-1-2014-10-22"><a href="#_2-1-1-2014-10-22" aria-hidden="true" class="header-anchor">#</a> 2.1.1 / 2014-10-22</h1> <ul><li>Fix handling of pipelined requests</li></ul> <h1 id="_2-1-0-2014-08-16"><a href="#_2-1-0-2014-08-16" aria-hidden="true" class="header-anchor">#</a> 2.1.0 / 2014-08-16</h1> <ul><li>Check if <code>socket</code> is detached</li> <li>Return <code>undefined</code> for <code>isFinished</code> if state unknown</li></ul> <h1 id="_2-0-0-2014-08-16"><a href="#_2-0-0-2014-08-16" aria-hidden="true" class="header-anchor">#</a> 2.0.0 / 2014-08-16</h1> <ul><li>Add <code>isFinished</code> function</li> <li>Move to <code>jshttp</code> organization</li> <li>Remove support for plain socket argument</li> <li>Rename to <code>on-finished</code></li> <li>Support both <code>req</code> and <code>res</code> as arguments</li> <li>deps: ee-first@1.0.5</li></ul> <h1 id="_1-2-2-2014-06-10"><a href="#_1-2-2-2014-06-10" aria-hidden="true" class="header-anchor">#</a> 1.2.2 / 2014-06-10</h1> <ul><li>Reduce listeners added to emitters
<ul><li>avoids &quot;event emitter leak&quot; warnings when used multiple times on same request</li></ul></li></ul> <h1 id="_1-2-1-2014-06-08"><a href="#_1-2-1-2014-06-08" aria-hidden="true" class="header-anchor">#</a> 1.2.1 / 2014-06-08</h1> <ul><li>Fix returned value when already finished</li></ul> <h1 id="_1-2-0-2014-06-05"><a href="#_1-2-0-2014-06-05" aria-hidden="true" class="header-anchor">#</a> 1.2.0 / 2014-06-05</h1> <ul><li>Call callback when called on already-finished socket</li></ul> <h1 id="_1-1-4-2014-05-27"><a href="#_1-1-4-2014-05-27" aria-hidden="true" class="header-anchor">#</a> 1.1.4 / 2014-05-27</h1> <ul><li>Support node.js 0.8</li></ul> <h1 id="_1-1-3-2014-04-30"><a href="#_1-1-3-2014-04-30" aria-hidden="true" class="header-anchor">#</a> 1.1.3 / 2014-04-30</h1> <ul><li>Make sure errors passed as instanceof <code>Error</code></li></ul> <h1 id="_1-1-2-2014-04-18"><a href="#_1-1-2-2014-04-18" aria-hidden="true" class="header-anchor">#</a> 1.1.2 / 2014-04-18</h1> <ul><li>Default the <code>socket</code> to passed-in object</li></ul> <h1 id="_1-1-1-2014-01-16"><a href="#_1-1-1-2014-01-16" aria-hidden="true" class="header-anchor">#</a> 1.1.1 / 2014-01-16</h1> <ul><li>Rename module to <code>finished</code></li></ul> <h1 id="_1-1-0-2013-12-25"><a href="#_1-1-0-2013-12-25" aria-hidden="true" class="header-anchor">#</a> 1.1.0 / 2013-12-25</h1> <ul><li>Call callback when called on already-errored socket</li></ul> <h1 id="_1-0-1-2013-12-20"><a href="#_1-0-1-2013-12-20" aria-hidden="true" class="header-anchor">#</a> 1.0.1 / 2013-12-20</h1> <ul><li>Actually pass the error to the callback</li></ul> <h1 id="_1-0-0-2013-12-20"><a href="#_1-0-0-2013-12-20" aria-hidden="true" class="header-anchor">#</a> 1.0.0 / 2013-12-20</h1> <ul><li>Initial release</li></ul></div> <div class="page-edit"><!----> <div class="last-updated"><span class="prefix">上次更新: </span> <span class="time">5/25/2019, 4:55:53 PM</span></div></div> <!----> </div> <!----></div></div>
    <script src="/assets/js/app.bbf0b81e.js" defer></script><script src="/assets/js/93.3cccb5d0.js" defer></script>
  </body>
</html>
