...
<a href="https://docs.npmjs.com/getting-started/installing-npm-packages-locally" target="_blank" rel="noopener noreferrer"><code>npm install</code> command<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg></a>:</p> <div class="language-sh extra-class"><pre class="language-text"><code>$ npm install forwarded
</code></pre></div><h2 id="api"><a href="#api" aria-hidden="true" class="header-anchor">#</a> API</h2> <div class="language-js extra-class"><pre class="language-js"><code><span class="token keyword">var</span> forwarded <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'forwarded'</span><span class="token punctuation">)</span>
</code></pre></div><h3 id="forwarded-req"><a href="#forwarded-req" aria-hidden="true" class="header-anchor">#</a> forwarded(req)</h3> <div class="language-js extra-class"><pre class="language-js"><code><span class="token keyword">var</span> addresses <span class="token operator">=</span> <span class="token function">forwarded</span><span class="token punctuation">(</span>req<span class="token punctuation">)</span>
...
furthest address, typically the end-user).</p> <h2 id="testing"><a href="#testing" aria-hidden="true" class="header-anchor">#</a> Testing</h2> <div class="language-sh extra-class"><pre class="language-text"><code>$ npm test
    ...
    <script src="/assets/js/app.bbf0b81e.js" defer></script><script src="/assets/js/67.6bd8be41.js" defer></script>
  </body>
</html>
